...
const activities = [
  ...
  },
  {
    ...
    icon: Leaf,
    description:
      'Help restore degraded areas of the forest through reforestation and habitat rehabilitation efforts.',
    tasks: [
  ...
  },
  {
    ...
    icon: Shield,
    description:
      'Join efforts to protect the forest from threats such as illegal logging, poaching, and encroachment.',
    tasks: [
  ...
  },
  {
    ...
    icon: Users,
    description:
      'Work with local communities to promote sustainable practices and environmental education.',
    tasks: [
...
const personalInfoSchema = z.object({
  ...
  emergencyContact: z
    .string()
    .min(10, { message: 'Please provide an emergency contact.' }),
});
...
const expertiseSchema = z.object({
  ...
  skills: z
    .string()
    .min(10, { message: 'Please describe your relevant skills.' }),
...
const motivationSchema = z.object({
  preferredActivity: z
    .string()
    .min(1, { message: 'Please select a preferred activity.' }),
  ...
  stayDuration: z
    .string()
    .min(1, { message: 'Please select your intended duration.' }),
  motivation: z.string().min(50, {
    message: 'Please describe your motivation (minimum 50 characters).',
  }),
  expectations: z.string().min(50, {
    message: 'Please describe your expectations (minimum 50 characters).',
  }),
...
export default function BecomeVolunteerPage() {
  ...
  const nextStep = async () => {
    ...
    if (step === 1) {
      ...
      isValid = await form.trigger(
        ['occupation', 'educationLevel', 'skills', 'languages'],
        { shouldFocus: true }
      );
    }
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-[#e8e4d5]/90 font-light leading-relaxed">
              Join our mission to protect and restore the unique biodiversity of
              Ivohiboro Lost Forest through hands-on conservation work and
      ...
      <section className="py-16 bg-[#e8e4d5]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-light tracking-wide text-[#3c4a3a] mb-6">
              Make a Difference in Ivohiboro
            </h2>
            <p className="text-[#3c4a3a]/80 leading-relaxed mb-8">
              Ivohiboro Lost Forest is a biodiversity hotspot facing numerous
              threats from deforestation, climate change, and habitat
              fragmentation. Our volunteer program offers a unique opportunity
              to contribute directly to conservation efforts while experiencing
              the extraordinary beauty and diversity of this unique ecosystem.
            </p>
            <p className="text-[#3c4a3a]/80 leading-relaxed">
              Whether you're a student, professional, retiree, or simply
              passionate about conservation, we welcome volunteers from all
              backgrounds who share our commitment to protecting this
              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-medium text-[#3c4a3a] mb-2">
                        {activity.title}
                      </h3>
                      <p className="text-[#3c4a3a]/80 mb-4">
                      ...
                      <ul className="space-y-1">
                        {activity.tasks.map((task, index) => (
                          <li
                            key={index}
                            className="flex items-start gap-2 text-sm text-[#3c4a3a]/80"
                          >
            ...
            <div className="bg-[#f5f2e8] p-8 rounded-sm">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-medium text-[#3c4a3a]">
                      Age Requirement:
                    </span>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[#3c4a3a]/80">
                      {' '}
                      Minimum 2 weeks, preferred 1 month or longer
                    </span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[#3c4a3a]/80">
                      {' '}
                      Basic English proficiency (French or Malagasy is a plus)
                    </span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[#3c4a3a]/80">
                      {' '}
                      Positive mindset, flexibility, cultural sensitivity, and
                      teamwork
                    </span>
                  </div>
                </li>
      ...
      <section className="py-16 bg-[#d8d4c5]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-light tracking-wide text-[#3c4a3a] mb-8 text-center">
              Apply to Volunteer
            </h2>
                ...
                <div className="flex items-center justify-between mb-8">
                  <div
                    className={`flex flex-col items-center ${
                      step >= 1 ? 'text-[#3c4a3a]' : 'text-[#3c4a3a]/40'
                    }`}
                  >
                    <div
                  ...
                  <div
                    className={`flex-1 h-0.5 mx-2 ${
                      step >= 2 ? 'bg-[#c4a76c]' : 'bg-[#3c4a3a]/20'
                    }`}
                  ></div>
                  <div
                    className={`flex flex-col items-center ${
                      step >= 2 ? 'text-[#3c4a3a]' : 'text-[#3c4a3a]/40'
                    }`}
                  >
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${
                  ...
                  <div
                    className={`flex-1 h-0.5 mx-2 ${
                      step >= 3 ? 'bg-[#c4a76c]' : 'bg-[#3c4a3a]/20'
                    }`}
                  ></div>
                  <div
                    className={`flex flex-col items-center ${
                      step >= 3 ? 'text-[#3c4a3a]' : 'text-[#3c4a3a]/40'
                    }`}
                  >
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 ${
                  ...
                  >
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-[#3c4a3a]">
                                  First Name
                                </FormLabel>
                                <FormControl>
                                  <Input
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription className="text-[#3c4a3a]/60">
                                Include both technical and soft skills that
                                would be valuable for conservation work.
                              </FormDescription>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription className="text-[#3c4a3a]/60">
                                E.g., English (fluent), French (intermediate),
                                Malagasy (basic)
                              </FormDescription>
                              <FormMessage />
                            </FormItem>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription className="text-[#3c4a3a]/60">
                                Optional - Include organizations, roles, and
                                duration
                              </FormDescription>
                              <FormMessage />
                            </FormItem>
                                ...
                                <Popover>
                                  ...
                                  >
                                    <Calendar
                                      ...
                                      disabled={(date) =>
                                        date <
                                        (form.getValues().availabilityStart ||
                                          new Date())
                                      }
                                      initialFocus
                                    />
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription className="text-[#3c4a3a]/60">
                                Please share your personal motivation and what
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription className="text-[#3c4a3a]/60">
                                Optional - This helps us ensure your safety and
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription className="text-[#3c4a3a]/60">
                                Optional - Any other information you think might
                                be relevant
                              </FormDescription>
                              <FormMessage />
                            </FormItem>
                    ...
                    <div className="flex justify-between pt-4">
                      ...
                      {step < 3 ? (
                        ...
                        <Button
                          type="submit"
                          className="ml-auto bg-[#c4a76c] text-[#262b22] hover:bg-[#b39c59]"
                        >
                          Submit Application
                        </Button>
                      )}
